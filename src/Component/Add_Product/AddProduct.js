...
const validate = (values) => {
  ...
  if (!values.product_created_by) {
    errors.product_created_by = "Required";
  }
  return errors;
};
    ...
    onSubmit: (values) => {
      fetch(`https://product-fhqo.onrender.com/products/`, {
        ...
        body: JSON.stringify({
          ...
          created_by: values.product_created_by,
        ...
        .then((response) => {
          if (!response.ok) {
            throw Error("Could not add the product please try again.");
          }
        ...
        .then(() => {
          setMessage({
            variant: "success",
            heading: "SUCCESS",
            message: "successfull product added",
          });
        })
          ...
          <Form onSubmit={formik.handleSubmit}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                type="text"
                placeholder="enter product creator name"
                {...formik.getFieldProps("product_created_by")}
              />
              {formik.errors.product_created_by ? (
                <Form.Text className="text-muted">
                  {formik.touched.product_created_by &&
                    formik.errors.product_created_by}
                </Form.Text>
              ) : null}
            </Form.Group>
